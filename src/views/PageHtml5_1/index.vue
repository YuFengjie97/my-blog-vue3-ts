    ...
    <div class="page_container">
      <div class="wrapper">
        ...
        <section id="first">
          ...
          <div class="content">
            <p>
              ...
              sit amet consectetur adipiscing elit. Duis dapibus rutrum
              facilisis. Class aptent taciti sociosqu ad litora torquent per
              conubia nostra, per inceptos himenaeos. Etiam tristique libero eu
              nibh porttitor amet fermentum. Nullam venenatis erat id vehicula
              ultrices sed ultricies condimentum. Magna sed etiam consequat, et
              lorem adipiscing sed nulla. Volutpat nisl et tempus et dolor
              libero, feugiat magna tempus, sed et lorem adipiscing.
            </p>
        ...
        <section>
          ...
          <div class="content">
            <p>
              <strong>Etiam tristique libero</strong>
              eu nibh porttitor amet fermentum. Nullam venenatis erat id
            ...
            <p>
              ...
              consequat, et lorem adipiscing sed nulla. Volutpat nisl et tempus
              et dolor libero, feugiat magna tempus, sed et lorem adipiscing.
            </p>
          </div>
        </section>
        ...
        <section>
          ...
          <div class="content">
            <p>
              <strong>Integer mollis egestas</strong>
              nam maximus erat id euismod egestas. Pellentesque sapien ac quam.
        ...
        <section>
          ...
          <div class="content">
            <p>
              <strong>Proin tempus feugiat</strong>
              sed varius enim lorem ullamcorper dolore aliquam aenean ornare
              velit lacus, ac varius enim lorem ullamcorper dolore.
            </p>
            <ul class="actions">
          ...
          <footer>
            <ul class="items">
              ...
              <li>
                ...
                <ul class="icons">
                  <li>
                    <a href="#" class="icon brands fa fa-twitter"></a>
                  </li>
                  <li>
                    <a href="#" class="icon brands fa fa-facebook-f"></a>
                  </li>
                  <li>
                    <a href="#" class="icon brands fa fa-instagram"></a>
                  </li>
                  <li>
                    <a href="#" class="icon brands fa fa-linkedin"></a>
                  </li>
                  <li>
                    <a href="#" class="icon brands fa fa-github"></a>
                  </li>
                  <li>
                    <a href="#" class="icon brands fa fa-codepen"></a>
                  </li>
                </ul>
              </li>
            </ul>
